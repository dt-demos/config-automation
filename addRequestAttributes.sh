...
# reference: https://www.dynatrace.com/support/help/extend-dynatrace/dynatrace-api/configuration-api/service-api/request-attributes-api/
 
CREDS_FILE=creds.json
RULES_DIR=./requestAttributes
source ./common.lib
